...
Phase 4 adds performance snapshots and engagement opportunities. Phase 5 adds growth experiments and generation snapshots. Phase 6 adds brand settings, generated visual assets, and media-type tracking. Phase 7 adds owned repositories, repository changes, and reviewed project facts. Phase 8 adds distribution workflows, creator relationships, and audience content signals. Apply the current Prisma schema once before opening Analytics, Engagement, Experiments, Projects, Distribution, or the Visual content studio:
